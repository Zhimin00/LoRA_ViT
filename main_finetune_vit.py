...
from util.datasets import build_dataset, build_dataset_vit
from util.pos_embed import interpolate_pos_embed
from util.misc import NativeScalerWithGradNormCount as NativeScaler
from huggingface_hub import hf_hub_download, login
from engine_finetune import train_one_epoch, evaluate, train_one_epoch_vit, evaluate_vit
import pdb
import warnings
import faulthandler
...
def get_args_parser():
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='vit-large-patch16-224', type=str,
...
def main(args, criterion):
    ...
    # Confirm classifier is trainable
    for name, param in model.named_parameters():
        print(name, param.requires_grad)  # Should be True
    dataset_train = build_dataset_vit(is_train='train', args=args)
    dataset_val = build_dataset_vit(is_train='val', args=args)
    dataset_test = build_dataset_vit(is_train='test', args=args)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_vit(
        ...
        val_stats, val_score = evaluate_vit(data_loader_val, model, device, args, epoch, mode='val',
        ...
        if epoch == (args.epochs - 1):
            ...
            test_stats, auc_roc = evaluate_vit(data_loader_test, model, device, args, -1, mode='test',
                                           num_class=args.nb_classes, log_writer=None)
            print(test_stats, auc_roc)
